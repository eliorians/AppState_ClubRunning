    ...
    return (
        <div class='records-wrapper'>
            <div class = 'background-image' style={{backgroundImage: `url(${background})`}}>
                <center><p class='button'><a class='button' href="https://docs.google.com/spreadsheets/d/1x7RUIj6KCTUKUYUShmq8UoEaAgyULV9Ewr9Iqh_H8p4/edit?usp=sharing"> Click here for a better view of the Records page if needed!!</a></p></center>
                <div class = 'records'>
