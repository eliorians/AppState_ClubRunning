    ...
    return (
        <div class='records-wrapper'>
            <div class = 'background-image' style={{backgroundImage: `url(${background})`}}>
                ...
                <center><p class='record-button'><a class='button' href="https://docs.google.com/spreadsheets/d/1x7RUIj6KCTUKUYUShmq8UoEaAgyULV9Ewr9Iqh_H8p4/edit?usp=sharing" target='_blank' rel='noreferrer'>Click here to view as Google Doc</a></p></center>
